...
> = {
  contrast: {
    ...
    phaseId: 1,
    options: [
      { key: 'white', label: 'White', meta: { type: 'color', value: '#ffffff' } },
      { key: 'black', label: 'Black', meta: { type: 'color', value: '#000000' } },
      { key: 'grey', label: 'Grey', meta: { type: 'color', value: '#808080' } },
    ],
    choicesPerRound: 2,
    roundsPerSession: 20,
    chanceBaseline: 0.5,
  ...
  color: {
    ...
    phaseId: 2,
    options: [
      { key: 'red', label: 'Red', meta: { type: 'color', value: '#ff4444' } },
      { key: 'blue', label: 'Blue', meta: { type: 'color', value: '#4444ff' } },
      { key: 'green', label: 'Green', meta: { type: 'color', value: '#44ff44' } },
      { key: 'yellow', label: 'Yellow', meta: { type: 'color', value: '#ffff44' } },
    ],
    choicesPerRound: 4,
    roundsPerSession: 20,
    chanceBaseline: 0.25,
  ...
  shape: {
    ...
    phaseId: 3,
    options: [
      { key: 'circle', label: 'Circle', meta: { type: 'shape', value: 'circle' } },
      { key: 'square', label: 'Square', meta: { type: 'shape', value: 'square' } },
      { key: 'triangle', label: 'Triangle', meta: { type: 'shape', value: 'triangle' } },
      { key: 'star', label: 'Star', meta: { type: 'shape', value: 'star' } },
      { key: 'cross', label: 'Cross', meta: { type: 'shape', value: 'cross' } },
      { key: 'diamond', label: 'Diamond', meta: { type: 'shape', value: 'diamond' } },
    ],
    choicesPerRound: 4,
    roundsPerSession: 20,
    chanceBaseline: 0.25,
  ...
  symbol: {
    ...
    phaseId: 4,
    options: [
      { key: 'A', label: 'A', meta: { type: 'symbol', value: 'A' } },
      { key: 'B', label: 'B', meta: { type: 'symbol', value: 'B' } },
      { key: 'C', label: 'C', meta: { type: 'symbol', value: 'C' } },
      { key: 'D', label: 'D', meta: { type: 'symbol', value: 'D' } },
      { key: 'E', label: 'E', meta: { type: 'symbol', value: 'E' } },
      { key: 'F', label: 'F', meta: { type: 'symbol', value: 'F' } },
      { key: 'G', label: 'G', meta: { type: 'symbol', value: 'G' } },
      { key: 'H', label: 'H', meta: { type: 'symbol', value: 'H' } },
      { key: 'I', label: 'I', meta: { type: 'symbol', value: 'I' } },
      { key: 'J', label: 'J', meta: { type: 'symbol', value: 'J' } },
      { key: 'K', label: 'K', meta: { type: 'symbol', value: 'K' } },
      { key: 'L', label: 'L', meta: { type: 'symbol', value: 'L' } },
      { key: 'M', label: 'M', meta: { type: 'symbol', value: 'M' } },
      { key: 'N', label: 'N', meta: { type: 'symbol', value: 'N' } },
      { key: 'O', label: 'O', meta: { type: 'symbol', value: 'O' } },
      { key: 'P', label: 'P', meta: { type: 'symbol', value: 'P' } },
      { key: 'Q', label: 'Q', meta: { type: 'symbol', value: 'Q' } },
      { key: 'R', label: 'R', meta: { type: 'symbol', value: 'R' } },
      { key: 'S', label: 'S', meta: { type: 'symbol', value: 'S' } },
      { key: 'T', label: 'T', meta: { type: 'symbol', value: 'T' } },
      { key: 'U', label: 'U', meta: { type: 'symbol', value: 'U' } },
      { key: 'V', label: 'V', meta: { type: 'symbol', value: 'V' } },
      { key: 'W', label: 'W', meta: { type: 'symbol', value: 'W' } },
      { key: 'X', label: 'X', meta: { type: 'symbol', value: 'X' } },
      { key: 'Y', label: 'Y', meta: { type: 'symbol', value: 'Y' } },
      { key: 'Z', label: 'Z', meta: { type: 'symbol', value: 'Z' } },
    ],
    choicesPerRound: 10,
    roundsPerSession: 30,
    chanceBaseline: 0.1,
  ...
  'text-reading': {
    ...
    phaseId: 7,
    options: [
      { key: 'cat', label: 'CAT', meta: { type: 'text', value: 'CAT' } },
      { key: 'dog', label: 'DOG', meta: { type: 'text', value: 'DOG' } },
      { key: 'sun', label: 'SUN', meta: { type: 'text', value: 'SUN' } },
      { key: 'moon', label: 'MOON', meta: { type: 'text', value: 'MOON' } },
      { key: 'star', label: 'STAR', meta: { type: 'text', value: 'STAR' } },
      { key: 'tree', label: 'TREE', meta: { type: 'text', value: 'TREE' } },
      { key: 'fire', label: 'FIRE', meta: { type: 'text', value: 'FIRE' } },
      { key: 'water', label: 'WATER', meta: { type: 'text', value: 'WATER' } },
      { key: 'house', label: 'HOUSE', meta: { type: 'text', value: 'HOUSE' } },
      { key: 'bird', label: 'BIRD', meta: { type: 'text', value: 'BIRD' } },
    ],
    choicesPerRound: 4,
    roundsPerSession: 20,
    chanceBaseline: 0.25,
